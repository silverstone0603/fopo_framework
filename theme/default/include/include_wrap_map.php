<div class="wrap_map">
	<div class="nav_wrap">
		<div class="nav_contents">
			...
			<div class="search">
				<input id="s_query" class="fp-img-search" type="text" placeholder="오늘은 어디로 떠나고 싶으신가요?" value="<?php echo trim($_GET['q']); ?>" onkeyup="javascript: if(window.event.keyCode==13) getSearch();">
			</div>
			<div class="userinfo">
				<?php if($this->FOPO_AUTH->getStatus()!=="null"){ ?>
